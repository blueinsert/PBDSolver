...
{
    public class PBDRigidbody : MonoBehaviour
    {
        ...
        public virtual void OnEnable()
        {
            ...
            handle = solver.ColliderWorld.CreateRigidbody();
            handle.owner = this;
            UpdateIfNeeded(1);
        }
         ...
         */
        public virtual void UpdateVelocities(Vector3 linearDelta, Vector3 angularDelta)
        {
